...
As a jumping off point, [we have published the data standards](https://global-electrification-platform.github.io/User_Guide/user-manual/source/data_standards/GEP_DataStandards_v1.xlsx). We are continuously working with partners and clients to identify commonalities in our data collection and our data needs and work towards data conversion tools that allow for easier integration of new data into all our processes.
